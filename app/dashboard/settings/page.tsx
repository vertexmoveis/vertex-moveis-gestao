  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 p-6 max-w-2xl space-y-6">
        ...
        <Card>
          <CardHeader>
            <h2 className="text-sm font-semibold text-[#121212]">Credenciais de Demonstração</h2>
          </CardHeader>
          <CardBody>
            <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 space-y-2">
              <p className="text-xs font-semibold text-orange-700 uppercase tracking-wide">Login Admin</p>
              <div className="space-y-1">
                <p className="text-sm text-[#121212]"><span className="text-[#9E9E9E]">Email:</span> admin@vertexmoveis.com.br</p>
                <p className="text-sm text-[#121212]"><span className="text-[#9E9E9E]">Senha:</span> admin123</p>
              </div>
            </div>
          </CardBody>
        </Card>
