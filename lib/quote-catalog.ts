...
const QUOTE_FURNITURE_CATALOG: Record<string, readonly QuoteFurnitureGroup[]> = {
  Cozinha: [
    ...
    group('Organizadores de cozinha', ['Porta-temperos deslizante', 'Despenseiro extraível', 'Módulo com lixeira dupla', 'Módulo porta-bandejas', 'Módulo de canto com cestos giratórios', 'Gaveta sob o rodapé', 'Módulo porta-assadeiras'], [...CABINET_ACCESSORIES, 'Cesto aramado', 'Lixeira embutida']),
    group('Cozinha retrátil', ['Torre com mesa retrátil'], CABINET_ACCESSORIES, 'UNIT'),
  ...
  Banheiro: [
    group('Gabinete', ['Gabinete de cuba', 'Gabinete em L', 'Gabinete de canto', 'Gabinete suspenso', 'Gabinete de piso', 'Gabinete para cuba dupla', 'Gabinete com gavetas', 'Gabinete com gaveteiro', 'Gabinete acessível com vão livre'], [...CABINET_ACCESSORIES, 'Cesto de roupas']),
    group('Penteadeira', ['Penteadeira integrada à bancada'], [...CABINET_ACCESSORIES, 'Espelho'], 'LINEAR_METER'),
  ...
  Dormitório: [
    group('Guarda-roupa', ['Guarda-roupa de abrir', 'Guarda-roupa de correr', 'Guarda-roupa em L', 'Guarda-roupa de canto', 'Guarda-roupa com maleiro', 'Guarda-roupa com gaveteiro lateral', 'Guarda-roupa com TV', 'Guarda-roupa com penteadeira', 'Armário ponte sobre a cama', 'Guarda-roupa sob teto inclinado'], WARDROBE_ACCESSORIES),
    ...
    group('Cômoda e penteadeira', ['Cômoda', 'Cômoda com gaveteiro', 'Penteadeira', 'Penteadeira suspensa', 'Toucador', 'Penteadeira de canto'], [...CABINET_ACCESSORIES, 'Espelho']),
    ...
    group('Sapateira', ['Sapateira vertical', 'Sapateira baixa', 'Sapateira com espelho', 'Sapateira basculante'], CABINET_ACCESSORIES),
  ...
  Escritório: [
    ...
    group('Postos especiais', ['Mesa para computador gamer', 'Mesa para costura', 'Mesa para desenho', 'Bancada para videoconferência', 'Bancada para impressora 3D', 'Mesa de artesanato'], [...STANDARD_ACCESSORIES, 'Organizador de cabos'], 'UNIT'),
    group('Instrumentos musicais', ['Móvel para instrumentos musicais'], [...CABINET_ACCESSORIES, 'Fechadura']),
  ...
  'Espaço comercial': [
    ...
    group('Salão de beleza', ['Bancada de manicure', 'Estação de cabeleireiro'], [...STANDARD_ACCESSORIES, 'Espelho', 'Organizador de cabos'], 'UNIT'),
    group('Armazenamento de salão', ['Armário para produtos de salão'], [...CABINET_ACCESSORIES, 'Fechadura']),
  ],
  'Móvel especial': [
    ...
    group('Aproveitamento de vãos', ['Armário sob janela', 'Gavetões sob escada'], CABINET_ACCESSORIES),
...
const FURNITURE_SEARCH_ALIASES: Record<string, readonly string[]> = {
  ...
  'Módulo avulso para forno de embutir': ['forno embutir solto', 'forno solto', 'forno avulso'],
  'Módulo para forno de embutir com gaveteiro': ['forno com gaveteiro', 'forno embutir gaveteiro'],
  ...
  'Guarda-roupa sob teto inclinado': ['armario de sotao', 'roupeiro inclinado', 'armario sob telhado'],
  'Sapateira basculante': ['sapateira inclinavel', 'sapateira com porta basculante'],
  'Gaveta sob o rodapé': ['gaveta de rodape', 'gaveta no rodape'],
  'Módulo porta-assadeiras': ['organizador de formas', 'porta formas', 'porta assadeiras'],
  'Torre com mesa retrátil': ['mesa embutida na torre', 'torre com mesa dobravel'],
  'Gabinete acessível com vão livre': ['gabinete acessivel', 'gabinete adaptado', 'gabinete para cadeirante'],
  'Penteadeira integrada à bancada': ['toucador de banheiro', 'bancada de maquiagem'],
  'Bancada de manicure': ['mesa de manicure', 'mesa para unhas'],
  'Estação de cabeleireiro': ['bancada de cabeleireiro', 'bancada de barbearia', 'estacao de beleza'],
  'Armário para produtos de salão': ['armario de salao', 'armario para cosmeticos'],
  'Bancada para impressora 3D': ['mesa para impressora 3d', 'bancada de impressao 3d'],
  'Móvel para instrumentos musicais': ['armario para instrumentos', 'movel para guitarra', 'movel para violao'],
  'Mesa de artesanato': ['bancada de artesanato', 'mesa para trabalhos manuais'],
  'Armário sob janela': ['armario embaixo da janela', 'armario abaixo da janela'],
  'Gavetões sob escada': ['gavetas sob escada', 'gaveteiro embaixo da escada'],
